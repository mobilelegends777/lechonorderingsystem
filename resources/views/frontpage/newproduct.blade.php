    ...
    <div class="shop_2_left_top clearfix">
	 <div class="shop_2_left_top_inner_1 clearfix">
	  <div class="col-sm-8 shop_2_left_top_inner_1_left clearfix">
       ...
       <div class="shower_left clearfix">
       <h4><strong>New Products</h4></strong>
	  </div>
      </div>
	 ...
	 <div class="col-sm-4 center_1_middle_left_1 clearfix">
	  <div class="center_1_middle_left_1_inner">
	   <div class="ih-item square effect6 from_top_and_bottom"><a href="{{asset('frontpage/shop-details')}}">
                      <div class="img"><img src="{{asset('asset/New/Lechonrice.jpg')}}" alt="img"></div>
                      <div class="info">
                        <h3>add to cart</h3>
                      </div></a></div>
	  </div>
	  <div class="center_1_middle_left_2_inner">
	  <h3><a href="{{asset('frontpage/shop-details')}}">Lechon Rice</a></h3>
	 ...
	 <div class="col-sm-4 center_1_middle_left_1 clearfix">
	  ...
	  <div class="center_1_middle_left_2_inner">
	  <h3><a href="{{asset('frontpage/shop-details')}}">Liempo</a></h3>
	  <h5><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></h5>
	  <h6>Php 254.00</h6>
	 </div>
	 </div>
	 <div class="col-sm-4 center_1_middle_left_1 clearfix">
	  ...
	  <div class="center_1_middle_left_2_inner">
	  <h3><a href="{{asset('frontpage/shop-details')}}">Paa Chicken BBQ</a></h3>
	  <h5><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></h5>
	  <h6>Php 85.00</h6>
	 </div>
	 </div>
	 <div class="col-sm-4 center_1_middle_left_1 clearfix">
	  ...
	  <div class="center_1_middle_left_2_inner">
	  <h3><a href="{{asset('frontpage/shop-details')}}">Lechon Manok</a></h3>
	  <h5><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></h5>
	  <h6>Php 254.00</h6>
	 </div>
	 </div>
	 ...
	 <div class="col-sm-4 center_1_middle_left_1 clearfix">
	  <div class="center_1_middle_left_1_inner">
	   <div class="ih-item square effect6 from_top_and_bottom"><a href="{{asset('frontpage/shop-details')}}">
                      <div class="img"><img src="{{asset('asset/New/Pansitbihon.jpg')}}" alt="img"></div>
                      <div class="info">
                        <h3>add to cart</h3>
                      </div></a></div>
	  </div>
	  <div class="center_1_middle_left_2_inner">
	  <h3><a href="{{asset('frontpage/shop-details')}}">Pancit Guisado</a></h3>
	  <h5><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></h5>
	  <h6>Php 194.00</h6>
	 </div>
	 </div>
	 ...
	 <div class="col-sm-4 center_1_middle_left_1 clearfix">
	  <div class="center_1_middle_left_1_inner">
	   <div class="ih-item square effect6 from_top_and_bottom"><a href="{{asset('frontpage/shop-details')}}">
                      <div class="img"><img src="{{asset('asset/New/Liverbbq.jpg')}}" alt="img"></div>
                      <div class="info">
                        <h3>add to cart</h3>
                      </div></a></div>
	  </div>
	  <div class="center_1_middle_left_2_inner">
	  <h3><a href="{{asset('frontpage/shop-details')}}">Chicken Liver BBQ</a></h3>
	  <h5><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star"></i><i class="fa fa-star-o"></i></h5>
	  <h6>Php 26.00</h6>
	 </div>
	 </div>
